  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="{{url('guardar_indicaciones',$id)}}" method="post" class="needs-validation" novalidate id="formulario">
        ...
        <div class="card">
            <div class="card-header titulo">Lactantes {{$aspirante->id_grado == 1 ? 'A' : 'B'}}</div>
            <div class="p-2">
            <div class="row">
            ...
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  @if ($aspirante->indicaciones_cuidados == 1)
                  <label class="form-label">Toma leche a las 10, 13 o 17 hrs: </label>
                  @else
                  <label class="form-label">Toma leche cada: </label>
                  @endif
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="toma_leche" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">Materna: </label>
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="leche_materna" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
            ...
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">Forma de tomar: </label>
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="forma_tomar" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">Come papilla, picado fino o trocitos: </label>
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="come_papilla" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
            ...
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">Indicación especial de alimentos: </label>
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="indicacion_alimentos" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
            ...
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">En qué horario del colegio y qué cantidad: </label>
                </div>
                <div class="col-md-10 col-sm-12">
            ...
            <div class="row align-items-center mt-2" style={{$aspirante->indicaciones_cuidados == 1 ? 'display:none' : ''}}>
                <div class="col-md-2 col-sm-12 text-center">
                  <label class="form-label">Duerme siesta a las 10, 13 o a las 17 hrs: </label>
                </div>
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="duerme_siesta" >
                </div>
            </div>
            <div class="row align-items-center mt-2">
                <div class="col-md-2 col-sm-12 text-center">
            ...
            <div class="row align-items-center mt-2">
                ...
                <div class="col-md-10 col-sm-12">
                  <input type="text" class="form-control" name="usa_chupon" required>
                </div>
            </div>
            <div class="row align-items-center mt-2">
              <div class="col-md-2 col-sm-12 text-center">
